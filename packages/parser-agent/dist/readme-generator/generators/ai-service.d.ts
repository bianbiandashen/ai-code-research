...
export declare class AIService {
     ...
     * @returns 生成的架构概览分析文本
     */
    generateArchitectureAnalysis(prompt: string): Promise<string>;
    /**
     * 生成目录详细分析
     *
     ...
     * @returns 生成的目录详细分析文本
     */
    generateDirectoryAnalysis(prompt: string): Promise<string>;
    /**
     * 生成综合分析报告
     *
     ...
     * @returns 生成的综合分析报告文本
     */
    generateComprehensiveReport(prompt: string): Promise<string>;
    /**
     * 生成业务组件分析
     *
     ...
     * @returns 生成的业务组件分析文本
     */
    generateBusinessComponentAnalysis(prompt: string): Promise<string>;
}
/**
 * AI 生成错误类
 *
 ...
 * - 测试和开发环境的便捷使用
 */
export declare const defaultAIService: AIService;
