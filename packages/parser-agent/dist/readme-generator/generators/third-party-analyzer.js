...
exports.ThirdPartyAnalyzer = void 0;
class ThirdPartyAnalyzer {
    ...
    getComponentDescription(library, componentName) {
        const descriptions = {
            'element-plus': {
    ...
    generateStatistics(components) {
        const libraryCount = new Map();
...
exports.ThirdPartyAnalyzer = ThirdPartyAnalyzer;
