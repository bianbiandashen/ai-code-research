...
exports.defaultAIService = exports.AIGenerationError = exports.AIService = void 0;
...
class AIService {
     ...
     * @returns 生成的架构概览分析文本
     */
    async generateArchitectureAnalysis(prompt) {
     ...
     * @returns 生成的目录详细分析文本
     */
    async generateDirectoryAnalysis(prompt) {
        return this.generateText(prompt, {
            maxTokens: 3000,
            temperature: 0.6
        });
     ...
     * @returns 生成的综合分析报告文本
     */
    async generateComprehensiveReport(prompt) {
        return this.generateText(prompt, {
            maxTokens: 6000,
            temperature: 0.7
        });
     ...
     * @returns 生成的业务组件分析文本
     */
    async generateBusinessComponentAnalysis(prompt) {
        return this.generateText(prompt, {
            maxTokens: 3500,
            temperature: 0.6
        });
...
exports.AIGenerationError = AIGenerationError;
/**
 * 默认AI服务实例
 *
 ...
 * - 测试和开发环境的便捷使用
 */
exports.defaultAIService = new AIService();
