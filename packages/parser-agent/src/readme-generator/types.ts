...
export interface ProjectStructure {
    ...
    fileDistribution: { [key: string]: number };
}
...
export interface CodeStats {
    ...
    fileTypeStats: { [key: string]: FileTypeStats };
}
...
export interface ArchitectureAnalysis {
    pattern: string; // MVC, MVP, MVVM, 组件化, 微服务等
    layers: string[];
    dataFlow: string;
