import { getWorkspacePath, getEntitiesFilePath } from "@xhs/shared-utils";

// 获取工作空间路径数组（支持多workspace）
const workspacePaths = getWorkspacePath();
const entitiesFilePaths = getEntitiesFilePath('entities.enriched.json');
